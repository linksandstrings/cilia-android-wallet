...
public class AddressUtils {
    ...
    public static Address from(CryptoCurrency currencyType, String address) {
        ...
        if (currencyType instanceof BitcoinMain || currencyType instanceof BitcoinTest || currencyType instanceof BitcoinILMain || currencyType instanceof BitcoinILTest || currencyType instanceof FIOToken) {
    ...
    //Use for bitcoinil address
    public static Address fromBitcoinILAddress(BitcoinILAddress address) {
        CryptoCurrency currency = address.getNetwork().isProdnet() ? BitcoinILMain.get() : BitcoinILTest.get();
        return new BtcILAddress(currency, address);
    }
