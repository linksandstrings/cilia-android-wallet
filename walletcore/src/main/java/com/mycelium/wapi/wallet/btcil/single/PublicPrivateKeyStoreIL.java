 ...
 */
public class PublicPrivateKeyStoreIL {

   private SecureKeyValueStore _secureStorage;

   public PublicPrivateKeyStoreIL(SecureKeyValueStore secureStorage) {
   ...
   public InMemoryPrivateKey getBitcoinILPrivateKey(byte[] addressBytes, KeyCipher cipher) throws KeyCipher.InvalidKeyCipher {
   ...
   public InMemoryPrivateKey getBitcoinILPrivateKey(Address address, KeyCipher cipher) throws KeyCipher.InvalidKeyCipher {
      return getBitcoinILPrivateKey(address.getBytes(), cipher);
   }
