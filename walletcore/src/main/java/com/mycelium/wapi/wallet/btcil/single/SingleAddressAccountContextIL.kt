 ...
 */
class SingleAddressAccountContextIL constructor(
        val id: UUID,
        var addresses: Map<AddressType, BitcoinILAddress>,
    ...
    constructor(context: SingleAddressAccountContextIL) :
     ...
     */
    fun persistIfNecessary(backing: SingleAddressBtcILAccountBacking) {
        if (isDirty) {
            persist(backing)
        }
    }
     ...
     */
    fun persist(backing: SingleAddressBtcILAccountBacking) {
