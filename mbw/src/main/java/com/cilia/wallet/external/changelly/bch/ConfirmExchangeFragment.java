...
import com.cilia.wallet.event.SpvSendFundsResult;
import com.cilia.wallet.external.changelly.ChangellyAPIService;
import com.cilia.wallet.external.changelly.ChangellyAPIService.ChangellyTransaction;
import com.cilia.wallet.external.changelly.Constants;
import com.cilia.wallet.external.changelly.ExchangeLoggingService;
import com.cilia.wallet.external.changelly.model.Order;
import com.cilia.wallet.pdf.BCHExchangeReceiptBuilder;
...
import static com.cilia.wallet.external.changelly.ChangellyAPIService.BCH;
import static com.cilia.wallet.external.changelly.ChangellyAPIService.BTC;
...
import static com.cilia.wallet.external.changelly.bch.ExchangeFragment.BCH_EXCHANGE;
import static com.cilia.wallet.external.changelly.bch.ExchangeFragment.BCH_EXCHANGE_TRANSACTIONS;
...
public class ConfirmExchangeFragment extends Fragment {
    ...
    public void spvSendFundsResult(SpvSendFundsResult event) {
        ...
        downloadConfirmationDialog = new AlertDialog.Builder(getActivity(), R.style.CiliaModern_Dialog)
                .setView(view)
                .setOnDismissListener(new DialogInterface.OnDismissListener() {
                    @Override
                    public void onDismiss(DialogInterface dialogInterface) {
