...
public class TransactionDetailsLabel extends BlockExplorerLabel {
   ...
   public void setTransaction(final TransactionSummary tx) {
      ...
      if (coluMode) {
         ...
         String typeName = transaction.getType().getName();
         BlockExplorerManager blockExplorerManager = mbwManager._blockExplorerManager.getBEMByCurrency(typeName);
         setHandler(blockExplorerManager.getBlockExplorer());
      }
   }
