...
import com.cilia.wallet.activity.modern.model.accounts.AccountListItem.Type.GROUP_ARCHIVED_TITLE_TYPE
import com.cilia.wallet.activity.modern.model.accounts.AccountListItem.Type.GROUP_TITLE_TYPE
...
class AccountsViewLiveData(private val mbwManager: MbwManager) : LiveData<List<AccountsGroupModel>>() {
    ...
    private inner class DataUpdateAsyncTask : AsyncTask<Void, List<AccountsGroupModel>, List<AccountsGroupModel>>() {
        override fun doInBackground(vararg voids: Void): List<AccountsGroupModel> {
            ...
            mutableListOf(R.string.active_btcil_accounts_name to walletManager.getBTCILBip44Accounts(),
                    R.string.active_hd_accounts_name to walletManager.getBTCBip44Accounts()
