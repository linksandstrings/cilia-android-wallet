...
package com.cilia.wallet.activity.pop;
...
class PopUtils {
   public static boolean matches(PopRequest popRequest, MetadataStorage metadataStorage, TransactionSummary transaction) {
