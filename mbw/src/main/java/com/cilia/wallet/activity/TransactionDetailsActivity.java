...
import com.cilia.wallet.activity.util.TransactionDetailsLabel;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (detailsFragment == null) {
            ...
            if (account instanceof EthAccount || account instanceof ERC20Account) {
                ...
                transaction.add(R.id.spec_details_fragment, BtcILDetailsFragment.newInstance(tx, coluMode, accountId));
            } else {
