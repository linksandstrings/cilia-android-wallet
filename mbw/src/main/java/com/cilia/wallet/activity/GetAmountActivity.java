...
import com.cilia.wallet.CurrencySwitcher;
import com.cilia.wallet.MbwManager;
import com.cilia.wallet.NumberEntry;
import com.cilia.wallet.NumberEntry.NumberEntryListener;
import com.cilia.wallet.R;
import com.cilia.wallet.Utils;
import com.cilia.wallet.activity.modern.Toaster;
import com.cilia.wallet.activity.util.ExchangeValueKt;
   ...
   private void checkSendAmount(final Value value, final CheckListener listener) {
      new AsyncTask<Void, Void, AmountValidation>() {
         ...
         protected AmountValidation doInBackground(Void... voids) {
            ...
            try {
               if ((_account instanceof HDAccountIL)||(_account instanceof SingleAddressAccountIL))
               {
                  _account.createTx(_account.getDummyAddress(destinationAddress.getSubType()), value, new FeePerKbFeeIL(_kbMinerFee), null);
               }else{
