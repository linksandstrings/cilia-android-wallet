package com.cilia.wallet.activity.settings.helper;
...
import com.cilia.wallet.activity.settings.adapter.DialogListAdapter;
...
public class DisplayPreferenceDialogHandler implements PreferenceManager.OnDisplayPreferenceDialogListener {
    ...
    public void onDisplayPreferenceDialog(Preference preference) {
        int theme = R.style.CiliaSettings_Dialog_Small;
