...
import com.cilia.wallet.activity.AboutActivity;
...
import com.cilia.wallet.activity.view.ButtonPreference;
import com.cilia.wallet.activity.view.TwoButtonsPreference;
import com.cilia.wallet.lt.LocalTraderEventSubscriber;
import com.cilia.wallet.lt.LocalTraderManager;
import com.cilia.wallet.lt.api.GetTraderInfo;
import com.cilia.wallet.lt.api.SetNotificationMail;
...
public class SettingsFragment extends PreferenceFragmentCompat {
    ...
    private final Preference.OnPreferenceClickListener onClickLedgerSetUnpluggedAID = new Preference.OnPreferenceClickListener() {
        ...
        public boolean onPreferenceClick(Preference preference) {
            AlertDialog.Builder b = new AlertDialog.Builder(requireActivity(), R.style.CiliaSettings_Dialog_Small);
            ...
            helpPrefs.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                ...
                public boolean onPreferenceClick(Preference preference) {
                    startActivity(Intent.createChooser(new Intent(Intent.ACTION_SENDTO)
                            .setData(Uri.parse("mailto:support@bitcoinil.com")), getString(R.string.send_mail)));
                    return false;
                }
            });
        }
    ...
    private class SubscribeToServerResponse extends LocalTraderEventSubscriber {
        ...
        public void onLtTraderInfoFetched(final TraderInfo info, GetTraderInfo request) {
            pleaseWait.dismiss();
            AlertDialog.Builder b = new AlertDialog.Builder(requireActivity(), R.style.CiliaSettings_Dialog);
