...
import com.cilia.wallet.external.partner.model.MediaFlowBannerInList
        ...
        when (item.type) {
            TYPE_TURN_OFF -> {
                ...
                holder.itemView.noButton.setOnClickListener {
                    AlertDialog.Builder(holder.itemView.context, R.style.CiliaModern_Dialog_BlueButtons)
