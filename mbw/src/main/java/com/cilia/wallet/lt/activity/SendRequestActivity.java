...
package com.cilia.wallet.lt.activity;
...
import com.cilia.wallet.lt.activity.sell.CreateOrEditAdActivity;
import com.cilia.wallet.lt.api.CreateAd;
import com.cilia.wallet.lt.api.CreateTrade;
import com.cilia.wallet.lt.api.EditAd;
import com.cilia.wallet.lt.api.GetTradeSession;
...
public class SendRequestActivity extends Activity {
   ...
   private LocalTraderEventSubscriber ltSubscriber = new LocalTraderEventSubscriber(new Handler()) {
      ...
      public void onLtTradeSessionFetched(com.mycelium.lt.api.model.TradeSession tradeSession,
            com.cilia.wallet.lt.api.GetTradeSession request) {
         TradeActivity.callMe(SendRequestActivity.this, tradeSession);
         finish();
      }

      @Override
      public void onLtTradeReceivingAddressSet(com.cilia.wallet.lt.api.SetTradeReceivingAddress request) {
      ...
      @Override
      public void onLtAdRetrieved(com.mycelium.lt.api.model.Ad ad, com.cilia.wallet.lt.api.GetAd request) {
      ...
      public void onLtPublicTraderInfoFetched(com.mycelium.lt.api.model.PublicTraderInfo info,
            com.cilia.wallet.lt.api.GetPublicTraderInfo request) {
