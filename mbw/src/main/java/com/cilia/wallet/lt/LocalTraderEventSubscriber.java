...
import com.cilia.wallet.lt.api.*;
...
public abstract class LocalTraderEventSubscriber {
   ...
   public void onLtBtcILReleased(Boolean success, ReleaseBtcIL request) {
      onLtGenericSuccess(request);
   }
   ...
   public void onLtBtcILSellPriceAssesed(BtcSellPrice btcSellPrice, AssessBtcILSellPrice request) {
      onLtGenericSuccess(request);
   }
