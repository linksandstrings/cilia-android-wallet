...
import com.cilia.wallet.exchange.GetExchangeRate;
...
import static com.cilia.wallet.Constants.DEFAULT_EXCHANGE;
import static com.cilia.wallet.external.changelly.ChangellyAPIService.BCH;
// import static com.cilia.wallet.external.changelly.ChangellyAPIService.BTC; gets shadowed by the local definition of the same value.
...
public class ExchangeRateManager implements ExchangeRateProvider {
        ...
        for (GetExchangeRatesResponse response : latestRates) {
            ...
            if (_currentExchangeSourceName.get(fromCurrency) == null) {
                ...
                if (exchangeSourceNames != null && !exchangeSourceNames.isEmpty()) {
                    String exchange = exchangeSourceNames.contains(DEFAULT_EXCHANGE) ?
                            DEFAULT_EXCHANGE : exchangeSourceNames.get(0);
    ...
    public ExchangeRate getExchangeRate(String source, String destination, String exchangeSource) {
        ...
        if (exchangeSource == null) {
            ...
            exchangeSource = DEFAULT_EXCHANGE;
        }
