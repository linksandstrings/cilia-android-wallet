...
package com.cilia.wallet.extsig.trezor;
...
public class TrezorManagerIL extends ExternalSignatureDeviceManagerIL {
   public TrezorManagerIL(Context context, NetworkParameters network, Bus eventBus) {
   ...
   public int getBIP44AccountType() {
      return HDAccountContextIL.ACCOUNT_TYPE_UNRELATED_X_PUB_EXTERNAL_SIG_TREZOR;
   }
