...
package com.cilia.wallet.extsig.keepkey;
...
public class KeepKeyManagerIL extends ExternalSignatureDeviceManagerIL {
   public KeepKeyManagerIL(Context context, NetworkParameters network, Bus eventBus) {
   ...
   public int getBIP44AccountType() {
      return HDAccountContextIL.ACCOUNT_TYPE_UNRELATED_X_PUB_EXTERNAL_SIG_KEEPKEY;
   }
