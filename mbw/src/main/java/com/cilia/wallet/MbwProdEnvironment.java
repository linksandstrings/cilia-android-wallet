...
public class MbwProdEnvironment extends MbwEnvironment {
   /**
    * The legacy thumbprint of the Cilia certificate.
   ...
   public com.mrd.bitillib.model.NetworkParameters getBitcoinILNetwork(){
      return com.mrd.bitillib.model.NetworkParameters.productionNetwork;
   }
   ...
   private static final Map<String, List<BlockExplorer>> prodnetExplorerClearEndpoints = new HashMap<String, List<BlockExplorer>>() {{
      ...
      put(BitcoinILMain.get().getName(), new ArrayList<BlockExplorer>() {{
         add(new BlockExplorer("CLA", "cilia", "https://explorer.cilia.camp/address/", "https://explorer.cilia.camp/tx/", null, null));
         add(new BlockExplorer("BCL", "bitcoinil", "https://explorer.bitcoinil.org/address/", "https://explorer.bitcoinil.org/tx/", null, null));
      }});
