...
//    public static final String[] ColuBlockExplorerApiURLs = {"https://coloredcoins.gear.mycelium.com/api/", "https://explorer.coloredcoins.org/api/"};
    ...
    public static void main(String[] args) {
        ...
        final TcpEndpoint[] bitcoinILtcpEndpoints = new TcpEndpoint[]{new TcpEndpoint("tcp-tls://testelectrumx.cilia.camp", 50002)};
        Wapi wapiClient = new WapiClientElectrumX(testnetWapiEndpoints, tcpEndpoints, bitcoinILtcpEndpoints, "0", 1);
