...
public class BitcoinILTransactionOutputEx implements Serializable {
   ...
   public BitcoinILTransactionOutputEx(@JsonProperty("outPoint") BitcoinILOutPoint outPoint, @JsonProperty("height") int height,
   ...
   public boolean equals(Object obj) {
      ...
      if (!(obj instanceof BitcoinILTransactionOutputEx)) {
         return false;
      }
      BitcoinILTransactionOutputEx other = (BitcoinILTransactionOutputEx) obj;
