...
public class BtcILTransactionDetails implements Comparable<BtcILTransactionDetails>, Serializable {
   ...
   public static class Item implements Serializable {
      ...
      public Item(BitcoinILAddress address, long value, boolean isCoinbase) {
    ...
    */
   public BtcILTransactionDetails(BitcoinILSha256Hash hash, int height, int time, Item[] inputs, Item[] outputs, int rawSize) {
      this.hash = hash;
      this.height = height;
      this.time = time;
      this.inputs = inputs;
   ...
   public boolean equals(Object obj) {
      ...
      if (!(obj instanceof BtcILTransactionDetails)) {
         return false;
      }
      BtcILTransactionDetails other = (BtcILTransactionDetails) obj;
      return other.hash.equals(this.hash);
   }


   @Override
   public int compareTo(BtcILTransactionDetails other) {
