...
public class ExchangeBasedBitcoinILCashValue extends ExchangeBasedCurrencyValue {
   ...
   protected ExchangeBasedBitcoinILCashValue(String currency, BigDecimal value) {
      this(currency, value, null);
   }

   protected ExchangeBasedBitcoinILCashValue(String currency, BigDecimal value, ExactCurrencyValue basedOnExactValue) {
      super(currency, basedOnExactValue);
      if (value != null) {
         this.value = BitcoinILCash.nearestValue(value);
      } else {
         this.value = null;
      }
   }

   protected ExchangeBasedBitcoinILCashValue(String currency, Long satoshis, ExactCurrencyValue basedOnExactValue) {
      super(currency, basedOnExactValue);
      if (satoshis != null) {
         this.value = BitcoinILCash.valueOf(satoshis);
      } else {
         this.value = null;
      }
   }
