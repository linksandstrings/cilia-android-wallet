...
public abstract class CurrencyValue implements Serializable {
   ...
   public static final String BTCIL = "BTCIL";
   ...
   public boolean isBtcIL() {
      return getCurrency().equals(BTCIL);
   }
   ...
   public BitcoinILValue getBitcoinILValue(ExchangeRateProvider exchangeRateManager) {
      if (this instanceof BitcoinILValue) {
         return ((BitcoinILValue) this);
      } else {
         if (this instanceof ExactCurrencyValue) {
            return (BitcoinILValue) ExchangeBasedBitcoinILValue.fromValue(this, exchangeRateManager);
         } else if (this instanceof ExchangeBasedCurrencyValue) {
            return (BitcoinILValue) ExchangeBasedBitcoinILValue.fromValue(this.getExactValue(), exchangeRateManager);
         } else {
            throw new RuntimeException("Unable to convert to BitcoinIL");
         }
      }
   }
   ...
   public BitcoinILs getAsBitcoinIL(ExchangeRateProvider exchangeRateManager) {
      return getBitcoinILValue(exchangeRateManager).getAsBitcoinIL();
   }
