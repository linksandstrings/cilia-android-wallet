...
public class CurrencyBasedBalance {
   ...
   public final static CurrencyBasedBalance ZERO_BITCOINIL_BALANCE = new CurrencyBasedBalance(
           ExactBitcoinILValue.ZERO, ExactBitcoinILValue.ZERO, ExactBitcoinILValue.ZERO);

   public final static CurrencyBasedBalance ZERO_BITCOINIL_CASH_BALANCE = new CurrencyBasedBalance(
           ExactBitcoinILCashValue.ZERO, ExactBitcoinILCashValue.ZERO, ExactBitcoinILCashValue.ZERO);
