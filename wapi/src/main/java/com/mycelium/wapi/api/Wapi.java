...
public interface Wapi {
   ...
   String MYCELIUM_VERSION_HEADER = "CiliaVersion";
   ...
   WapiResponse<QueryUnspentOutputsResponse> queryUnspentOutputs(QueryUnspentOutputsRequest request);
    @Deprecated
    WapiResponse<BitcoinILQueryUnspentOutputsResponse> queryBitcoinILUnspentOutputs(BitcoinILQueryUnspentOutputsRequest request);
   ...
   WapiResponse<QueryTransactionInventoryResponse> queryTransactionInventory(QueryTransactionInventoryRequest request);
    ...
    @Deprecated
    WapiResponse<QueryBitcoinILTransactionInventoryResponse> queryBitcoinILTransactionInventory(QueryBitcoinILTransactionInventoryRequest request);
   ...
   WapiResponse<GetTransactionsResponse> getTransactions(GetTransactionsRequest request);
    ...
    @Deprecated
    WapiResponse<GetBitcoinILTransactionsResponse> getBitcoinILTransactions(GetBitcoinILTransactionsRequest request);
   ...
   WapiResponse<BroadcastBitcoinILTransactionResponse> broadcastBitcoinILTransaction(BroadcastTransactionRequest request);
   ...
   @Deprecated
   WapiResponse<CheckBitcoinILTransactionsResponse> checkBitcoinILTransactions(CheckBitcoinILTransactionsRequest request);
   ...
   WapiResponse<BitcoinILMinerFeeEstimationResponse> getBitcoinILMinerFeeEstimations();
}
