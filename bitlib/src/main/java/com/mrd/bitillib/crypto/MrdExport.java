...
public class MrdExport {
   ...
   public static class V1 {
       ...
       * @param network                   the BitcoinIL network this key is meant for
      ...
      /**
       * Encrypt a standard BitcoinIL private key for either testnet or prodnet
       ...
       * @param network                 the BitcoinIL network used
      ...
      public static char calculatePasswordChecksum(String password) {
         ...
         BitcoinILSha256Hash hash = HashUtils.sha256(password.getBytes(PASSWORD_CHARACTER_ENCODING));
      ...
      /**
       * Calculate the checksum from sha256 hash of the bitcoinil address of a
       * private key
       */
