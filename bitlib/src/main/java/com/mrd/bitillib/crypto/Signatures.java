...
public class Signatures {
   ...
   static{
      try {
         HEADER = "BitcoinIL Signed Message:\n".getBytes("UTF-8");
   ...
   // checks the signature and enforces a Low-S Value - to counter the bitcoinil
   // transaction malleability problem, according to Bip62
   // https://github.com/bitcoinil/bips/blob/master/bip-0062.mediawiki#New_rules, pt5
