...
import com.mrd.bitillib.model.CompactInt;
...
public class ByteReader {
   ...
   public BitcoinILSha256Hash getBitcoinILSha256Hash() throws InsufficientBytesException {
      checkAvailable(BitcoinILSha256Hash.HASH_LENGTH);
      return BitcoinILSha256Hash.of(getBytes(BitcoinILSha256Hash.HASH_LENGTH));
   }
