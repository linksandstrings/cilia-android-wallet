...
public class TransactionUtils {
   /**
    * The miner fee per 1000 bytes used by BitcoinIL Core 0.9.x for block inclusion. Still valid 0.14
    */
    ...
    */
   public static boolean hasInSufficientFees(BitcoinILTransaction tx, UnspentTransactionOutput[] funding, long minerFeeToUse) {
   ...
   private static long calculateFeePaid(BitcoinILTransaction tx, UnspentTransactionOutput[] funding) {
      long fee = 0;
