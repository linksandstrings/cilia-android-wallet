...
import com.mrd.bitillib.model.Script.ScriptParsingException;
...
public class TransactionInput implements Serializable {
   ...
   public BitcoinILOutPoint outPoint;
   ...
   public static TransactionInput fromByteReader(ByteReader reader) throws TransactionInputParsingException {
      try {
         BitcoinILSha256Hash outPointHash = reader.getBitcoinILSha256Hash().reverse();
         ...
         BitcoinILOutPoint outPoint = new BitcoinILOutPoint(outPointHash, outPointIndex);
         ScriptInput inscript;
         if (outPointHash.equals(BitcoinILSha256Hash.ZERO_HASH)) {
   ...
   public TransactionInput(BitcoinILOutPoint outPoint, ScriptInput script, int sequence, long value) {
   ...
   public TransactionInput(BitcoinILOutPoint outPoint, ScriptInput script) {
   ...
   public void toByteWriter(ByteWriter writer) {
      writer.putBitcoinILSha256Hash(outPoint.txid, true);
