/**
 * Parts of this code was extracted from the BitcoinILJ library from
 * http://code.google.com/p/bitcoinilj/.
 */
package com.mrd.bitillib.bitcoinj;
...
/**
 * <p>
 * Base58 is a way to encode BitcoinIL addresses as numbers and letters. Note that
...
public class Base58 {
   ...
   /**
    * Encode an array of bytes as Base58 with an appended checksum as in BitcoinIL
    * address encoding
    */
   public static String encodeWithChecksum(byte[] input) {
      ...
      BitcoinILSha256Hash checkSum = HashUtils.doubleSha256(b, 0, input.length);
   ...
   public static byte[] decodeChecked(String input) {
      ...
      BitcoinILSha256Hash sha256Hash = HashUtils.doubleSha256(bytes);
