...
import com.mrd.bitillib.util.CoinUtil
...
open class UnsignedTransaction constructor(
    ...
    init {
        ...
        val transaction = BitcoinILTransaction(1, inputs, this.outputs, lockTime)
    ...
    private fun getInputScript(publicKey: PublicKey, transaction: BitcoinILTransaction, i: Int, isNested: Boolean) {
